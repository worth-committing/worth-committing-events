...
add_action( 'cmb2_admin_init', 'ccw_events_event_description' );
/**
 * Define the metabox and field configurations.
 */
function ccw_events_event_description() {
	...
	$cmb = new_cmb2_box( array(
		'id'            => 'the_event_description',
		'title'         => __( 'Event Description', 'wc_events' ),
